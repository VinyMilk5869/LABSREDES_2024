...
def leer_registros(transaction_id):
    position1 = int(input("Primer registro para leer: "))
    position2 = int(input("Ultimo registro para leer: "))
...
def modificar_coil(transaction_id):
    position = int(input("ID del Coil que desea modificar: "))
    value = int(input("Nuevo estado: "))
...
def interpretar_trama_modbus(trama):
    ...
    if function_code == 0x03:
        ...
        print("Registro", register_address, " modificado, valor nuevo: ", new_value)
